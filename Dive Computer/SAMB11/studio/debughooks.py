...
def HandlePatchBreakpoint(api):
	...
	api.Write32(0x1004000c,0x10005515)	# rw_main (Function)
	api.Write32(0x10040010,0x10005645)	# rwip_eif_get (Function)
	api.Write32(0x1004004c,0x100056d1)	# XTAL_mode_check (Function)
	api.Write32(0x10040034,0x100057db)	# system_sleep (Function)
	api.Write32(0x10040068,0x10005c69)	# rwble_isr (Function)
	api.Write32(0x10040088,0x10005dad)	# lld_evt_schedule (Function)
	api.Write32(0x100400bc,0x10005f25)	# gapm_get_task_from_id (Function)
	api.Write32(0x100400e4,0x10006065)	# ke_msg_send (Function)
	api.Write32(0x100400e8,0x100062d5)	# rf_init (Function)
	api.Write32(0x100400ec,0x10006389)	# ulp_rf_init (Function)
	api.Write32(0x1004010c,0x10006535)	# rwip_sleep (Function)
	api.Write32(0x10040154,0x1000677d)	# intc_init (Function)	
	api.Write32(0x10040150,0x10006817)	# aon_sleep_timer_irq_fn (Function)
	api.Write32(0x10040160,0x10006855)	# uart_init (Function)
	api.Write32(0x10040174,0x100069d1)	# ulp_wakeup (Function)
	api.Write32(0x10040210,0x10007575)	# clkClb_informAction (Function)
	api.Write32(0x10040038,0x10005a0d)	# early_entry (Function)
	api.Write32(0x1000003C,0x100059e9)	# 0x1000003C (Address)
	...
	api.Write32(0x100400dc,0x00019831)
